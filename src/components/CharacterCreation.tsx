...
export const CharacterCreation: React.FC<CharacterCreationProps> = ({
  ...
  const handleStartGame = () => {
    ...
    const playerEntity: Entity = {
      ...
      inventory: [
        {
          id: 'guild_potion', name: 'Guild Healing Draught', description: 'Ramuan penyembuh resmi Guild (Heal 2d4+2 HP).', type: 'potion', effect: 'heal', rarity: 'common', value: 50, count: 2,
        },
        {
          id: 'guild_flare', name: 'Luminescent Flare', description: 'Obor magis pemberi ketenangan (Memberi status INSPIRED / Advantage).', type: 'scroll', effect: 'inspiration', rarity: 'common', value: 75, count: 1,
        },
      ],
